...
class Header extends Component {
    ...
    loginClickHandler = () => {
        ...
        xhrLogin.addEventListener("readystatechange", function () {
            if (this.readyState === 4 && this.status === 200) {
                ...
                that.setState({
                    loggedIn: true,
                    loggedInUserName: user.first_name,
                ...
                sessionStorage.setItem("loggedInUserName",user.first_name);
    ...
    signUp(dataSignup) {
        ...
        xhrSignup.open("POST", this.props.baseUrl + resourcePath);
        xhrSignup.setRequestHeader("Content-Type", "application/json");
        xhrSignup.setRequestHeader("Cache-Control", "no-cache");
        xhrSignup.send(JSON.stringify({contact_number:this.state.contact, email_address:this.state.email,first_name:this.state.firstname,last_name:this.state.lastname,password:this.state.registerPassword}));
