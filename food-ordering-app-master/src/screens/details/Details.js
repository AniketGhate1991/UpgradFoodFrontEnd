        ...
        xhr.addEventListener("readystatechange", function(){
            if(this.readyState === 4 && this.status === 200) {
                ...
                that.setState({
                    ...
                    items: JSON.parse(this.responseText).categories.item_list
                });
            }
        });

        xhr.open("GET", this.props.baseUrl + resourcePath + this.props.match.params.restaurantID);
                        ...
                        <div className="rating-cost">
                            <div className="restaurant-rating">
                                ...
                                <p className="sub-text">Average rating by <span
                                    className="bold">{restaurant.number_customers_rated}</span> users</p>
                            </div>
